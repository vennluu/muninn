...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.countAccessibleObjectTypesStmt, err = db.PrepareContext(ctx, countAccessibleObjectTypes); err != nil {
		return nil, fmt.Errorf("error preparing query CountAccessibleObjectTypes: %w", err)
	}
	...
	if q.getGDPStatsStmt, err = db.PrepareContext(ctx, getGDPStats); err != nil {
		return nil, fmt.Errorf("error preparing query GetGDPStats: %w", err)
	}
	...
	if q.getObjectsByTypeStatsStmt, err = db.PrepareContext(ctx, getObjectsByTypeStats); err != nil {
		return nil, fmt.Errorf("error preparing query GetObjectsByTypeStats: %w", err)
	}
	...
	if q.getPublicObjectFactsStmt, err = db.PrepareContext(ctx, getPublicObjectFacts); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicObjectFacts: %w", err)
	}
	if q.getPublicObjectTypeValuesStmt, err = db.PrepareContext(ctx, getPublicObjectTypeValues); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicObjectTypeValues: %w", err)
	}
	if q.getPublicObjectTypesStmt, err = db.PrepareContext(ctx, getPublicObjectTypes); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicObjectTypes: %w", err)
	}
	if q.getPublicObjectsByTypeStmt, err = db.PrepareContext(ctx, getPublicObjectsByType); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicObjectsByType: %w", err)
	}
	if q.getPublicRecentFactsStmt, err = db.PrepareContext(ctx, getPublicRecentFacts); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicRecentFacts: %w", err)
	}
	if q.getPublicRecentFactsByTypeStmt, err = db.PrepareContext(ctx, getPublicRecentFactsByType); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicRecentFactsByType: %w", err)
	}
	if q.getPublicStatsStmt, err = db.PrepareContext(ctx, getPublicStats); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicStats: %w", err)
	}
	if q.getPublicTopObjectsStmt, err = db.PrepareContext(ctx, getPublicTopObjects); err != nil {
		return nil, fmt.Errorf("error preparing query GetPublicTopObjects: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.countAccessibleObjectTypesStmt != nil {
		if cerr := q.countAccessibleObjectTypesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing countAccessibleObjectTypesStmt: %w", cerr)
		}
	}
	...
	if q.getAccessibleObjectTypesForMemberStmt != nil {
		if cerr := q.getAccessibleObjectTypesForMemberStmt.Close(); cerr != nil {
	...
	if q.getGDPStatsStmt != nil {
		if cerr := q.getGDPStatsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getGDPStatsStmt: %w", cerr)
		}
	}
	...
	if q.getObjectsByTypeStatsStmt != nil {
		if cerr := q.getObjectsByTypeStatsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getObjectsByTypeStatsStmt: %w", cerr)
		}
	}
	...
	if q.getPublicObjectStmt != nil {
		if cerr := q.getPublicObjectStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicObjectStmt: %w", cerr)
		}
	}
	if q.getPublicObjectFactsStmt != nil {
		if cerr := q.getPublicObjectFactsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicObjectFactsStmt: %w", cerr)
		}
	}
	if q.getPublicObjectTypeValuesStmt != nil {
		if cerr := q.getPublicObjectTypeValuesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicObjectTypeValuesStmt: %w", cerr)
		}
	}
	if q.getPublicObjectTypesStmt != nil {
		if cerr := q.getPublicObjectTypesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicObjectTypesStmt: %w", cerr)
		}
	}
	if q.getPublicObjectsByTypeStmt != nil {
		if cerr := q.getPublicObjectsByTypeStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicObjectsByTypeStmt: %w", cerr)
		}
	}
	if q.getPublicRecentFactsStmt != nil {
		if cerr := q.getPublicRecentFactsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicRecentFactsStmt: %w", cerr)
		}
	}
	if q.getPublicRecentFactsByTypeStmt != nil {
		if cerr := q.getPublicRecentFactsByTypeStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicRecentFactsByTypeStmt: %w", cerr)
		}
	}
	if q.getPublicStatsStmt != nil {
		if cerr := q.getPublicStatsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicStatsStmt: %w", cerr)
		}
	}
	if q.getPublicTopObjectsStmt != nil {
		if cerr := q.getPublicTopObjectsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPublicTopObjectsStmt: %w", cerr)
		}
	}
	...
	if q.grantAccessToObjectTypeStmt != nil {
		if cerr := q.grantAccessToObjectTypeStmt.Close(); cerr != nil {
...
type Queries struct {
	...
	countAccessibleObjectTypesStmt           *sql.Stmt
	...
	getPublicObjectTypesStmt                 *sql.Stmt
	getPublicObjectsByTypeStmt               *sql.Stmt
	getPublicRecentFactsStmt                 *sql.Stmt
	getPublicRecentFactsByTypeStmt           *sql.Stmt
	getPublicStatsStmt                       *sql.Stmt
	getPublicTopObjectsStmt                  *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		countAccessibleObjectTypesStmt:           q.countAccessibleObjectTypesStmt,
		...
		getPublicObjectTypesStmt:                 q.getPublicObjectTypesStmt,
		getPublicObjectsByTypeStmt:               q.getPublicObjectsByTypeStmt,
		getPublicRecentFactsStmt:                 q.getPublicRecentFactsStmt,
		getPublicRecentFactsByTypeStmt:           q.getPublicRecentFactsByTypeStmt,
		getPublicStatsStmt:                       q.getPublicStatsStmt,
		getPublicTopObjectsStmt:                  q.getPublicTopObjectsStmt,
