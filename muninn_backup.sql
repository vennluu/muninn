...
\restrict K10MMMFej4hAUJI2mcPIbcS9Qa9UPamaZnN0kZ14JcZ99dCkrcvheNKWtzNvYOF
...
CREATE TABLE public.automated_action_execution (
    ...
    error_message text,
    execution_log jsonb,
    CONSTRAINT automated_action_execution_status_check CHECK (((status)::text = ANY ((ARRAY['running'::character varying, 'completed'::character varying, 'failed'::character varying])::text[])))
);
...
CREATE TABLE public.creator (
    ...
    CONSTRAINT creator_role_check CHECK (((role)::text = ANY ((ARRAY['admin'::character varying, 'member'::character varying])::text[])))
);
...
CREATE TABLE public.import_task (
    ...
    CONSTRAINT import_task_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'processing'::character varying, 'completed'::character varying, 'failed'::character varying])::text[])))
);
...
CREATE TABLE public.task (
    ...
    CONSTRAINT task_status_check CHECK (((status)::text = ANY ((ARRAY['todo'::character varying, 'doing'::character varying, 'paused'::character varying, 'completed'::character varying])::text[])))
);
...
04dddb1b-058a-49ee-b591-f72ae26e7de2	2cc425da-8574-4c3d-9d3b-dd76dcfbd842	hello	--- With condition ---\nhhhh\n--- Apply ---\nFunnel: Start-up	{"typeIds": []}	{"funnelId": "6e64c621-1c3e-4c78-8da4-fe65348a2dbf"}	t	2026-03-03 09:08:20.685483+07	2025-11-16 22:05:09.689443+07	2026-03-03 09:08:20.685483+07	d243501b-8131-4a8a-879a-e7fcb85e2813	\N
\.
...
\unrestrict K10MMMFej4hAUJI2mcPIbcS9Qa9UPamaZnN0kZ14JcZ99dCkrcvheNKWtzNvYOF
